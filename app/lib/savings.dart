...
//   void initState() {
//     queryText = "";
//     queryStream = fakeSpendRecordEntries.snapshots();
//     super.initState();
//   }
//
//   @override
...
//               stream: queryStream as Stream<QuerySnapshot<FakeSpendRecord>>,
...
//                   return
//                     TableSpend(data.docs.map((e) => e.data() as FakeSpendRecord). toList());
//                 }
//
...
// }
//
// class TableSpend extends StatelessWidget {
//   TableSpend(List<FakeSpendRecord> docs);
//
//   @override
//   Widget build(BuildContext context) {
//     return Text("dd");
